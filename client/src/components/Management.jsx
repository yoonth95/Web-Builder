          ...
          <div key={menu.idx} className='menu_list'>
            <div className='primaryMenus_wrap'>
              ...
              {editMenuIds.includes(menu.idx) && (
                <form
                  className='edit_wrap'
                  onSubmit={(e) => updateMenu(e, menu.idx)}
                >
                  <label
                  ...
                  <div className='edit_wrap_sub'>
                    ...
                    />
                    <label
                      htmlFor={`primaryMenu_chkBox_${menu.idx}`}
                      className='txt_new_window'
                    >
                      새 창 열기
                    </label>
                  ...
                  .map((submenu) => (
                    <div className='subMenus_wrap' key={submenu.idx}>
                      ...
                      {editMenuIds.includes(submenu.idx) && (
                        <form
                          className='edit_wrap'
                          onSubmit={(e) => updateMenu(e, submenu.idx)}
                        >
                          <label
                          ...
                          <div className='edit_wrap_sub'>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleNewWindowValue(e, submenu.idx)
                              }
                            />
                            <label
                              htmlFor={`subMenu_chkBox_${submenu.idx}`}
                              className='txt_new_window'
                            >
                              새 창 열기
                            </label>
